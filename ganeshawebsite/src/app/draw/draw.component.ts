  ...
  archGallery = [
    {
      title: 'Logos',
      images: [
        { url: 'assets/img/draw/draw_grinch.jpg', img: 'assets/img/draw/draw_grinch.jpg', alt: 'draw', width: 15 },
        { url: 'assets/img/draw/draw_mufasa.jpg', img: 'assets/img/draw/draw_mufasa.jpg', alt: 'draw', width: 15 },
